...
import ajk.riset.ajk_riset.adapter.CustomListInfoPesanan;
...
public class InfoDataPenyelesaian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idPengguna = Pengguna(pref.getString("username", "kosong"));
    ...
    private class LongOperation extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(InfoDataPenyelesaian.this);
        ...
        protected Void doInBackground(String... urls) {
            ...
            JSONObject json = JSONFunction.getJSONfromURL("http://agarwood.web.id/infopenyelesaian.php?id=" + idPengguna);
