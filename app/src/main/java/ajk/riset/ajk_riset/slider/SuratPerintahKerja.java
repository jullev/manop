   ...
   public EditText jumlahPesan, Keterangan;
    ...
    private class LongOperation extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            //UI Element
            adapter.delPemesanan(database);
            adapter.delPengerajin(database);
        ...
        protected Void doInBackground(String... urls) {
            ...
            JSONObject json = JSONFunction.getJSONfromURL("http://agarwood.web.id/data_pesanan.php");
//            	JSONObject json = JSONFunctions.getJSONfromURL("http://192.168.137.1/AppsaniApp_new/login.php?username="+unameere+"&password="+pass);
            try {
...
//				.getJSONfromURL("http://koento-agency.co.id/demo/appsani/json/barang.php");
                    .getJSONfromURL("http://agarwood.web.id/data_pengrajin.php");
