 ...
 */
public class CustomListMasterProduk extends ArrayAdapter<String> {
    private String[] names;
    private String[] desc;
    private Integer[] imageid;
    private Activity context;

    public CustomListMasterProduk(Activity context, String[] names, String[] desc, Integer[] imageid) {
